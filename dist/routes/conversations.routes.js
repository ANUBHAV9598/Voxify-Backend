...
router.post("/direct", async (req, res) => {
    ...
    try {
        ...
        const existingConversationMembers = await prisma.conversationMember.findMany({
            where: {
...
router.post("/group", async (req, res) => {
    ...
    const uniqueMemberIds = Array.from(new Set(parsed.data.memberIds.filter((memberId) => memberId !== userId)));
